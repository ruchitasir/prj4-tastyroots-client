            ...
            return (
                <div>
                    <Form.Group columns='equal'>
                        ...
                        <Form.Select fluid required label='Unit' name="unit" value={ing.unit} options={props.unitOptions} onChange={(e, data) => props.handleIngredientUnitChange(e, data, ind)} placeholder="Select" />
                        <Form.Field >
