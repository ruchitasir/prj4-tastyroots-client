    ...
    return (
      <Container className="top-spacing-2">
        <Grid stackable columns={4}>
          ...
          <Grid.Row>
            <Grid.Column width={2} className="square"></Grid.Column>
            <Grid.Column width={12}>
              <Image src="https://res.cloudinary.com/tasty-roots/image/upload/v1592190475/tasty-roots/Beet_v1_xgmdwg.png" alt="logo" />
            </Grid.Column>
            <Grid.Column width={2} className="square"></Grid.Column>
          </Grid.Row>
          <Grid.Row>
